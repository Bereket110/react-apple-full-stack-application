      ...
      <div className="container">
        ...
        <div className="row footer-links-wrapper">
          ...
          <div className="col col-12 col-sm-6 col-m-4 col-lg-2">
            ...
            <h3 id="health">For Healthcare</h3>
            <ul className="health-li">
              <li>
                <a href="#">Manage Your Apple ID</a>
              </li>
              <li>
          ...
          <div className="col col-12 col-sm-6 col-m-4 col-lg-2">
            <h3 id="app-val">Apple Values</h3>
            <ul className="app-val-li">
              <li>
                <a href="#">Find a Store</a>
              </li>
              <li>
            ...
            <h3 id="about-apple">About Apple</h3>
            <ul className="about-apple-li">
              <li>
                <a href="#">Find a Store</a>
              </li>
              <li>
